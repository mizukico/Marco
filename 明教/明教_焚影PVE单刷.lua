...
if not jianshang then jianshang=0 end
...
if dwSkillId ==18372 then
if s_util.CastSkill(9004,false) then return end
jianshang=1
return
end
if dwSkillId ==18368 then
if s_util.CastSkill(3973,true) then return end
return
end
if jianshang==1 then if s_util.CastSkill(3973,true) then jianshang=0 return end end
--简化日月能量
